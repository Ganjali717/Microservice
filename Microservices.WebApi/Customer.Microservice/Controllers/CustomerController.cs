...
namespace Customer.Microservice.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public IActionResult AddIssue(Entity.Customer issue)
        {
        ...
        {
            var issue = _context.Customers.FirstOrDefault(x => x.Name == title);
            return issue == null ? NotFound() : Ok(issue);
        }
        ...
        public IActionResult UpdateIssue(Entity.Customer model)
        {
